...
coursesArray.forEach(value => {
    ...
    itemDiv.style.border = '1px solid blue';
    let titleDiv = document.createElement('div');
    titleDiv.style.margin = '10px';
    titleDiv.style.border = '1px solid blue';
    let durattion = document.createElement('div');
    durattion.style.display = 'flex';
    durattion.style.columnGap = '20px';
    durattion.style.margin = '10px';
    durattion.style.border = '1px solid blue';
    ...
    itemDiv.append(titleDiv);
    itemDiv.append(durattion);
    durattion.append(monthDuration, hourDuration);
    itemDiv.append(modules);
