...
// - За допомоги циклу проітерувати  масив users, записати кожного юзера в сівй блок за
// допомоги document.createElement, розділивши всі властивості по своїм блокам , блок з адресою
...
//     ruleH2.innerText = `${item.title}`;
//
//
//     let ruleP = document.createElement('p');
//     ruleP.innerText = `${item.body}`;
//
//
//
//     idRule++;
//     ruleDiv.append(id, ruleH2, ruleP);
